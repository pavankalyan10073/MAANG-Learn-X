...
export const Route = createFileRoute("/track/cloud-devops/videos")({
  head: () => ({
    meta: [
      { title: "Cloud & DevOps Video Full Course — MAANG Learn X" },
      { name: "description", content: "Complete Cloud & DevOps video courses and playlists from top educators. AWS, Docker, CI/CD, Kubernetes and deployment." },
    ],
  }),
  component: CloudDevopsVideosPage,
});
...
const videoGroups = [
  {
    label: "DevOps — Full Courses",
    icon: "🚀",
    color: "from-blue-500 to-cyan-600",
    items: [
      { title: "DevOps Full Course (2025) — Intellipaat", url: "https://youtu.be/4m9j6hlbf4g?si=JH6G4h6uPNJiYDB0", desc: "Complete DevOps course 2025 — Docker, Kubernetes, Jenkins, Ansible, Terraform, CI/CD and more", isPlaylist: false },
      { title: "DevOps Full Course FREE — Intellipaat", url: "https://youtu.be/saWZQr0RMpw?si=_0q9OwMLKZPzOUcl", desc: "Free DevOps full course covering all essential tools and concepts for beginners to advanced", isPlaylist: false },
    ],
  },
  {
    label: "AWS & Cloud — Full Courses",
    icon: "☁️",
...
function CloudDevopsVideosPage() {
    ...
    <div className="px-4 py-6 sm:px-6 sm:py-8 md:px-12 md:py-10 max-w-7xl mx-auto">
      ...
      <section className="mb-10">
        <div className="relative overflow-hidden rounded-2xl border border-border bg-card/60 backdrop-blur">
          ...
          <div className="absolute inset-0 bg-[url('/tracks/cloud-devops-sections/video-courses.png')] bg-cover bg-center opacity-[0.07]" />
          <div className="relative z-10 p-6 sm:p-8 md:p-10">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-3">Cloud & DevOps <span className="text-gradient">Video Full Course</span></h1>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mb-6">Complete video lectures for Cloud & DevOps — AWS, Docker, CI/CD, Kubernetes, Terraform, Vercel and deployment strategies.</p>
