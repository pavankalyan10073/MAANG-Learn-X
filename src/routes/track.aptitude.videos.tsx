...
export const Route = createFileRoute("/track/aptitude/videos")({
  head: () => ({
    meta: [
      { title: "Aptitude Video Full Course — MAANG Learn X" },
      { name: "description", content: "Complete aptitude video courses and playlists — quantitative, logical reasoning and verbal ability." },
    ],
  }),
  component: AptitudeVideosPage,
});
...
const videoGroups = [
  {
    label: "Aptitude Preparation Playlists",
    icon: "📐",
  ...
  },
  {
    ...
    items: [
      { title: "Feel Free to Learn Banking", url: "https://www.youtube.com/c/FeelFreetoLearnBanking/playlists", desc: "Banking exam aptitude playlists — quantitative aptitude, reasoning and English for competitive exams", isPlaylist: true },
    ],
  },
  {
    label: "Code360 — Aptitude Preparation",
    icon: "🎓",
    color: "from-green-500 to-emerald-600",
    items: [
      { title: "Aptitude Preparation — Code360 (Naukri)", url: "https://www.naukri.com/code360/guided-paths/aptitude-preparation", desc: "Structured guided path for aptitude preparation — topic-wise modules with practice questions", isPlaylist: false },
    ],
  },
];

const stats = [
  { icon: FilmIcon, value: "4", label: "Playlists" },
  { icon: ClockIcon, value: "50+", label: "Hours" },
  { icon: SparklesIcon, value: "3", label: "Channels" },
];
    ...
    <div className="px-4 py-6 sm:px-6 sm:py-8 md:px-12 md:py-10 max-w-7xl mx-auto">
      ...
      <section className="mb-10">
        <div className="relative overflow-hidden rounded-2xl border border-border bg-card/60 backdrop-blur">
          ...
          <div className="absolute inset-0 bg-[url('/tracks/aptitude-sections/video-courses.png')] bg-cover bg-center opacity-[0.07]" />
          <div className="relative z-10 p-6 sm:p-8 md:p-10">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-3">Aptitude <span className="text-gradient">Video Full Course</span></h1>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mb-6">Complete video lectures for aptitude — quantitative, logical reasoning and verbal ability. Curated playlists from top educators and structured guided paths.</p>
