...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to track your MAANG prep progress." },
    ],
  }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4 py-10">
      <Card className="w-full max-w-md p-8 bg-card/80 backdrop-blur border-border shadow-card">
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Track progress across every prep track.
          </p>
        </div>
