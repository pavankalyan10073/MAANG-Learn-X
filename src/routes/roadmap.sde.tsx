...
const phases = [
  ...
  },
  {
    ...
    months: [
      ...
      { emoji: "📅", title: "MONTHS 10–12 — FAANG Interview Preparation", learn: [{icon:"💻",text:"DSA Mastery Track — 300+ Problems"},{icon:"🏗",text:"System Design — Design Twitter, Design Netflix, Design Uber"},{icon:"🧠",text:"Core CS — OS, DBMS, CN, OOPs"}], resources:[{label:"Striver A2Z DSA Sheet",icon:Code2Icon,url:"https://takeuforward.org/strivers-a2z-dsa-course/strivers-a2z-dsa-course-sheet-2/"},{label:"ByteByteGo",icon:LayersIcon,url:"https://bytebytego.com"}], projects:["Enterprise Full Stack App","AI SaaS Platform","Real-Time Chat System","Cloud Deployment Project","System Design Case Studies"] },
    ],
